...
This guide is intended for those who work as part of the parse-numeric product
...
Describes how to do a release for parse-numeric.

## 4. [Governance](governance.md)

Describes the governance policy for parse-numeric, including the rights and
